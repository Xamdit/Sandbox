...
function prompt_char {
  command git branch &>/dev/null && echo "${FG[210]} git${FG[226]} ●" || echo "${FG[226]} ◯"
}
...
folder='./$(basename "$PWD")'
PROMPT="╭─${FG[040]}%n ${FG[239]}${FG[239]}in %B${FG[226]}${folder}${git_info}${ruby_env}${virtualenv_info}${FG[666]}
╰─>${prompt_char}%{$reset_color%} "
